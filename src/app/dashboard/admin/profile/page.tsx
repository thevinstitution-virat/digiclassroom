                    ...
                    <div>
                      ...
                      {isEditing ? (
                        <input
                          ...
                          className={`w-full px-4 py-3 rounded-xl border-2 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent backdrop-blur-sm ${
                            errors.firstName
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-3">
                      {profileData.permissions.map((permission, index) => (
                        <div key={permission} className={`inline-flex items-center px-3 py-2 rounded-xl text-sm font-semibold text-white shadow-md ${
