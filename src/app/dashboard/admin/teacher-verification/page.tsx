...
export default function TeacherVerificationPage() {
  ...
  const fetchDocuments = async () => {
    try {
      ...
      const response = await fetch(`/api/admin/teacher-verification/documents?${params}`)
  ...
  const handleReviewSubmit = async () => {
    ...
    try {
      ...
      const response = await fetch('/api/admin/teacher-verification/review', {
        method: 'POST',
  ...
  const handleViewDocument = (document: VerificationDocument) => {
    ...
    window.open(`/api/admin/teacher-verification/view/${document.id}`, '_blank')
  }
