...
/**
 * GET /api/admin/materials/google-drive/credentials
...
export async function GET(request: NextRequest) {
  try {
    ...
    const credentials = {
      ...
      redirectUri: process.env.GOOGLE_DRIVE_REDIRECT_URI || 'http://localhost:3000/api/admin/materials/google-drive/callback'
    }
...
/**
 * POST /api/admin/materials/google-drive/credentials
...
/**
 * DELETE /api/admin/materials/google-drive/credentials
