-- VG Kosh Practest Engine Database Migration
-- Migration 003: Create Practest Tables

-- Question Bank Table - Core storage for all questions
CREATE TABLE IF NOT EXISTS practest_question_bank (
...
CREATE TABLE IF NOT EXISTS practest_test_configurations (
  id VARCHAR(36) PRIMARY KEY DEFAULT (UUID()),
...
CREATE TABLE IF NOT EXISTS practest_test_sessions (
  id VARCHAR(36) PRIMARY KEY DEFAULT (UUID()),
...
CREATE TABLE IF NOT EXISTS practest_question_analytics (
  id VARCHAR(36) PRIMARY KEY DEFAULT (UUID()),
...
CREATE TABLE IF NOT EXISTS practest_curriculum_structure (
  id VARCHAR(36) PRIMARY KEY DEFAULT (UUID()),
