  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="w-full max-w-md rounded-2xl bg-card p-6 shadow-xl">
        <h2 className="mb-4 text-xl font-bold text-foreground">Edit Organization Plan</h2>
        
        <div className="space-y-4">
          <div>
            <label className="mb-1 block text-sm font-medium text-foreground">Subscription Plan</label>
            <select 
              value={plan}
          ...
          <div>
            <label className="mb-1 block text-sm font-medium text-foreground">Subscription Status</label>
            <select 
              value={status}
          ...
          <div>
            <label className="mb-1 block text-sm font-medium text-foreground">Platform Fee Rate (%)</label>
            <Input 
              type="number"
              min="0"
              max="100"
            ...
            />
            <p className="mt-1 text-xs text-muted-foreground">Currently {(parseFloat(feeRate) || 0)}% (Saved as {(parseFloat(feeRate) / 100).toFixed(4)})</p>
          </div>
        </div>
